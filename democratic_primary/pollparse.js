...
d3.csv("https://projects.fivethirtyeight.com/polls-page/president_primary_polls.csv", function (data) {
    ...
    for (let l = 0; l <= no_days; l++) {
        ...
        polls_raw_us.forEach(function (d) {
            ...
            d.time_weighted_weight = d.weight / (1 + (((calc_date_new - d.end_date) / time_scale) / 2))
        ...
        newest_polls_us.forEach(function (d) {
            d.time_weighted_weight = d.time_weighted_weight / Math.pow(d.newest_poll, 8)
            return d;
        })
    ...
    projected_vote.forEach(function (d) {
        d.Biden = d.Biden + biden_bump;
        d.Bloomberg = d.Bloomberg + bloomberg_bump;
        d.Buttigieg = d.Buttigieg + buttigieg_bump;
        d.Klobuchar = d.Klobuchar + klobuchar_bump;
        d.Sanders = d.Sanders + sanders_bump;
        d.Steyer = d.Steyer + steyer_bump;
        d.Warren = d.Warren + warren_bump;
        d.Yang = d.Yang + yang_bump;
        return d;
    })
